...
#define LEDS_GREEN     4 /**< LED3 (Green)  */ //Non utilizzato
#define LEDS_ORANGE    8 /**< LED4 (Orange) */ //Non utilizzato
...
#define BOARD_IOID_LED_3          IOID_UNUSED //PER AGGIUNGERE LED
#define BOARD_IOID_LED_4          IOID_UNUSED //PER AGGIUNGERE LED
...
* @{
 */                                          
#define BOARD_IOID_UART_RX        IOID_0 //PIN RX    RX=0 -> CENTRALE  |  RX=8 -> GW
#define BOARD_IOID_UART_TX        IOID_11 //PIN TX   TX=11 -> CENTRALE |  TX=7 -> GW 
...
/*---------------------------------------------------------------------------*/
/**
 * \Button IOID Mapped, se si vuole aggiungere I/O
 *
 * Those values are not meant to be modified by the user
 * @{
 */
#define BOARD_IOID_KEY_LEFT       IOID_18 //SERVE PER UDP-SERVER
#define BOARD_IOID_KEY_RIGHT      IOID_UNUSED // X ADD I/0
...
#define BOARD_IOID_LCD_CS         IOID_1 //CS 
...
/*---------------------------------------------------------------------------*/
/**
 * \name ALS IOID mapping // Pin riservati per la comunicazione rx/tx
 *
 * Those values are not meant to be modified by the user
 * @{
 */
#define BOARD_IOID_ALS_PWR        IOID_26 // SERVE PER COMUNIC.RADIO
#define BOARD_IOID_ALS_OUT        IOID_23 // SERVE PER COMUNIC.RADIO
