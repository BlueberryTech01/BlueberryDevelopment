...
AUTOSTART_PROCESSES(&cetic_6lbr_process, &broadcast_example_process);
         ...
         uint16_t datalen)
{
     ...
     char *appdata;
      ...
      if(strcmp(appdata, "APRE") == 0) {
      leds_on(LEDS_RED);
      printf("Sta Aprendo\n");
    } else if(strcmp(appdata, "CHID") == 0) {
      leds_off(LEDS_RED);
      printf("Sta Chiudendo\n");
    } else if(strcmp(appdata, "APER") == 0) {
      leds_on(LEDS_YELLOW);
      printf("Porta Aperta\n");
    } else if(strcmp(appdata, "CHIU") == 0) {
      leds_off(LEDS_YELLOW);
      printf("Porta Chiusa\n");
    } else if(strcmp(appdata, "BLOC") == 0) {
      leds_on(LEDS_RED);
      printf("Porta in errore\n");
    } else if(strcmp(appdata, "STOP") == 0) {
      leds_on(LEDS_RED);
